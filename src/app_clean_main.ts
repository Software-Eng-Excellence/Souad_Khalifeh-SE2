import { OrderManagement, FinanceCalculator, Validator, PriceValidator, MaxPriceValidator } from "app-clean";
...
const calculator = new FinanceCalculator() as any;
const orderManager= new OrderManagement(new Validator(rules), calculator);
